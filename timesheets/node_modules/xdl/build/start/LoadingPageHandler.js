...
function getRuntimeVersion(exp, platform) {
  var _getRuntimeVersionNul;

  if (!platform) {
    return 'Undetected';
  }

  return (_getRuntimeVersionNul = (0, _Updates().getRuntimeVersionNullable)(exp, platform)) !== null && _getRuntimeVersionNul !== void 0 ? _getRuntimeVersionNul : 'Undetected';
}
